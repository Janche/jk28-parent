...
<shiro:hasPermission name="新增">
	<li><span id="topmenu" onclick="">新增</span><span id="tm_separator"></span></li>
</shiro:hasPermission>
 <shiro:hasPermission name="修改">
	<li><span id="topmenu" onclick="">修改</span><span id="tm_separator"></span></li>
</shiro:hasPermission>
<shiro:hasPermission name="删除">
	<li><span id="topmenu" onclick="">删除</span><span id="tm_separator"></span></li>
</shiro:hasPermission>
</ul>
    </div>
</div>
